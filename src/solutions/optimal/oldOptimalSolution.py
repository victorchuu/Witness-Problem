...
"""
DEPRECATED: Only bringing this class back to compare the time differences with the new branch & bound method
"""
...
def recursiveSearch(route: Route, instance: Instance, time, currentVertex) :
    ...
    for edge in instance.graph.get_adjacents(currentVertex):
...
def oldOptimalSolution(instance: Instance) :   
...
class SearchAlgorithm(Algorithm):
    ...
    def run(self, instance):
        return oldOptimalSolution(instance)
