...
class TestGeneticAlgorithm(unittest.TestCase):
    ...
    def test_executeAlgorithmsToCSV(self, time):
        ...
        # Act
        executeAlgorithms(algorithms, 'new-I1', CSVDataGatherer, suffix='-unittest',  startIn=2, endIn=4)

        # Assert
        with open('solutions/new-I1-unittest.csv', 'r') as csv_file:
            csv_data = csv_file.read()

        expected_csv_data = 'new-I1,Mean #2,Max #2,Time #2,Mean #3,Max #3,Time #3\n' + \
    ...
    def test_executeAlgorithmsRealCaseToCSV(self, time):
        ...
        # Act
        executeAlgorithms(algorithms, 'new-realCase', dataGatherer, suffix='-unittest',  startIn=2, endIn=4)

        # Assert
        with open('solutions/new-realCase-unittest.csv', 'r') as csv_file:
            csv_data = csv_file.read()

        expected_csv_data = 'new-realCase,Mean (0.0; 2),Max (0.0; 2),Mean hits (0.0; 2),real fitness (0.0; 2),Time (0.0; 2),Mean (0.0; 3),Max (0.0; 3),Mean hits (0.0; 3),real fitness (0.0; 3),Time (0.0; 3)\n' + \
